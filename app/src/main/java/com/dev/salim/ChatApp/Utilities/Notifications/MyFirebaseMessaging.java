package com.dev.salim.ChatApp.Utilities.Notifications;
...
public class MyFirebaseMessaging extends FirebaseMessagingService {
        ...
        if (firebaseUser != null && sented.equals(firebaseUser.getUid())) {
            if (!currentUser.equals(user)) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    sendUpNotification(remoteMessage);
                } else
    ...
    private void sendUpNotification(RemoteMessage remoteMessage) {
        ...
        Notification.Builder builder = oreoNotifications.getNotification(title, body, pendingIntent, defaultSound, icon);
